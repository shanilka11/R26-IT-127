...
*/
var isStandardBrowserWebWorkerEnv = typeof WorkerGlobalScope !== "undefined" && self instanceof WorkerGlobalScope && typeof self.importScripts === "function";
var browser_default = {
	isBrowser: true,
	classes: {
...
var knownAdapters = {
	...
	xhr: typeof XMLHttpRequest !== "undefined" && function(config) {
		return new Promise(function dispatchXhrRequest(resolve, reject) {
			...
			if (utils_default.isFormData(requestData)) if (browser_default.isStandardBrowserEnv || browser_default.isStandardBrowserWebWorkerEnv) requestHeaders.setContentType(false);
			else requestHeaders.setContentType("multipart/form-data;", false);
