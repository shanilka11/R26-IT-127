...
const DemandForecast = () => {
    ...
    try {
      const res = await axios.post(
        `${LocalIP}:4444/predict_demand`,
        {
          ...
          class_capacity: {
            "1st Class": Number(classCapacity["1st Class"]),
            "2nd Class": Number(classCapacity["2nd Class"]),
            "3rd Class": Number(classCapacity["3rd Class"]),
          },
        },
  ...
  return (
    <div className="df-page">
      ...
      <p className="df-subheading">Predict expected demand per travel class for a route</p>
